                ...
                <form action="{{ route('presences.update', $presence->id)}}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" id="status" class="form-select">
                            <option value="present" {{ ($presence->status == 'present') ? : '' }}>Present</option>
                            <option value="absent" {{ ($presence->status == 'absent') ? : '' }}>Absent</option>
                            <option value="leave" {{ ($presence->status == 'leave') ? : '' }}>Leave</option>
                        </select>
                        @error('status')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
