                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <p>{{ \Carbon\Carbon::parse($salary->pay_date)->format('d F Y') }}</p>
                            </div>

                            <div class="mb-3">
                                <label for="" class="form-label"><strong>Net Salary</strong></label>
                                <p>{{ number_format($salary->net_salary) }}</p>
                            </div>
                        </div>
